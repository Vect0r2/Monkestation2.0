...
///How much power does the AI data core use while being in a valid state. This is also the base heat output. (Divide by heat capacity to get actual temperature increase)
...
///How much is the AI download progress increased by per tick? Multiplied by a modifier on the AI if they have upgraded. Need to reach 100 to be downloaded
